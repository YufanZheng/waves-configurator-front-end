...
@Component({
  selector: 'reasoning-filter-settings',
  templateUrl: './reasoning-filter-settings.component.html',
  styleUrls: ['./reasoning-filter-settings.component.css']
})
export class ReasoningFilterSettingsComponent extends ComponentSettings implements OnInit, OnDestroy {
